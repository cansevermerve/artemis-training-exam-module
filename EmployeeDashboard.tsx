...
import { CheckCircle, ChevronLeft, ChevronRight, ClipboardList, Clock, RefreshCw, Search } from "lucide-react";
      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          <h1 className="flex items-center gap-2 text-xl font-semibold text-gray-900 dark:text-gray-100 sm:text-2xl">
            ...
            Eğitimlerim ve Sınavlarım
          </h1>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Size atanan eğitimleri, sınavları ve tamamlanma durumlarını tek ekrandan takip edin.
          </p>
        </div>
        ...
        <button
          ...
          disabled={isLoading}
          className="inline-flex shrink-0 items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700"
          aria-label="Eğitimleri yenile"
          title="Yenile"
        >
